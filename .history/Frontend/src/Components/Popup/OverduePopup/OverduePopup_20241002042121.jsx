  ...
  return (
    <div className="return-book-popup-container" data-testid="return-book-popup">
      <div className="return-book-popup">
        ...
        {borrowDetails && (
          <div>
            <p><strong>Borrower:</strong> {detail.First_Name} {detail.Last_Name}</p>
            <p><strong>Book Title:</strong> {detail.Title}</p>
            <p><strong>Borrow Date:</strong> {detail.Borrow_Date}</p>
            <p><strong>Due Date:</strong> {detail.Return_Date}</p>
          </div>
        )}
      </div>
    </div>
