      ...
      <div className="overdue-book-popup">
        ...
        {borrowDetails && (
          <div>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <strong>Borrow Time:</strong> {`${borrowDetails[0].Borrow_Date.split(":")[0]}:${borrowDetails[0].Borrow_Date.split(":")[1]}`}</p>
            <p><strong>Due Date:</strong> {new Date(borrowDetails[0].Return_Date).toLocaleDateString()} {/* Change Borrow_Date to Due_Date */}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <strong>Borrow Time:</strong> {`${borrowDetails[0].Borrow_Date.split(":")[0]}:${borrowDetails[0].Borrow_Date.split(":")[1]}`}
          </div>
        )}
        ...
        <div className="action-buttons">
          ...
          <button onClick={() => confirmReturn(borrowDetails[0].Borrow_ID)}>Return Without Payment</button>
          <button>Report as Lost</button>
        </div>
      </div>
      {showReturnModal && ( // Fix the conditional rendering here
        <ReturnBookPopup
