      ...
      <div className="return-book-popup">
        ...
        {borrowDetails && (
          <div>
            ...
            <p><strong>Borrow Date:</strong> {new Date(borrowDetails[0].Borrow_Date).toLocaleDateString()}</p>
            <p><strong>Due Date:</strong> {new Date(borrowDetails[0].Borrow_Date).toLocaleDateString()}</p>
          </div>
        )}
      </div>
    </div>
