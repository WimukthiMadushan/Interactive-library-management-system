...
function OverdueBookPopup({ onClose, borrowId, fetchBorrows }) {
  ...
  <div>
    ...
    <p><strong>Due Date:</strong> {new Date(borrowDetails[0].Due_Date).toLocaleDateString()} {/* Change Borrow_Date to Due_Date */}
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <strong>Due Time:</strong> {new Date(borrowDetails[0].Due_Date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
  </div>
)}
