      ...
      <div className="register-container">
        ...
        <form onSubmit={handleSubmit} data-testid="register-form">
          ...
          <div className="email-password">
            ...
            />
            <div className={`validation-message ${showEmailValidation ? "show" : ""}`}>
          ...
          <div className="password">
            ...
            />
            <div className={`validation-message ${showPasswordValidation ? "show" : ""}`}>
              Password must be at least 6 characters long and contain a mix of uppercase, lowercase, numbers, and symbols.
            </div>
