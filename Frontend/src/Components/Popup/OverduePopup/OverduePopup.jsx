      ...
      <div className="overdue-book-popup">
        ...
        {borrowDetails && (
          <div>
            ...
            <p><strong>Due Date:</strong> {new Date(borrowDetails[0].Return_Date).toLocaleDateString()}
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <strong>Borrow Time:</strong> {new Date(borrowDetails[0].Borrow_Date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
            </p>
            <p><strong>Overdue Fees:</strong><span style={{color:"red"}}> {borrowDetails[0].Overdue_Days} days</span></p>
